...
import { LoginSubmission } from "../types";
...
interface Props {
  ...
  onSubmitLogin: (login: LoginSubmission) => void
}
...
class LoginForm extends React.Component<Props, State> {
   ...
   */
  render() {
    const { classes, isSubmitting, formSubmissionError } = this.props;
    ...
    return (
      ...
      <ResponsiveLayout>
        <Segment className={classes.card}>
          <Form error={formSubmissionError} loading={isSubmitting} onSubmit={this.handleFormSubmit}>
